...
SetTurtleVelocity::SetTurtleVelocity(std::string node_name)
    ...
    this->callback_group_set_parameter_atomically_service_ptr_ = this->create_callback_group(rclcpp::CallbackGroupType::Reentrant);
    ...
    this->set_turtle_velocity_client_ptr_ = this->create_client<rcl_interfaces::srv::SetParametersAtomically>("set_parameters_atomically", rmw_qos_profile_services_default, this->callback_group_set_parameter_atomically_service_ptr_);
