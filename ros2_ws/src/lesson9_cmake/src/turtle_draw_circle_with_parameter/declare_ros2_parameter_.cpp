...
void TurtleDrawCircleWithParameter::declare_ros2_parameter_(std::string parameter_name){
    ...
    parameter_descriptor.floating_point_range = parameter_descriptor_floating_point_range; 
    // = parameter_descriptor_floating_point_range;
    // this->declare_parameter("name", parameter_name);
    // this->declare_parameter("value", 0.0)
    // this->declare_parameter("desctiptor", parameter_descriptor);
